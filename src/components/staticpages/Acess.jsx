        ...
        <ThemeProvider theme={theme}>
            ...
            <div className = 'body' ref={bodyRef} style={{  backgroundColor: highContrast ? "#000000" : '', minHeight: '100vh', padding: '3rem' }}>
                    ...
                    <ul style={{ color: highContrast ? "#FFFFFF" : 'inherit', fontWeight: highContrast ? "bold" : "normal" }}>
                        <li>
                            <Typography variant="body1" paragraph>
                                <a href="https://www.planalto.gov.br/ccivil_03/_ato2004-2006/2004/decreto/d5296.htm" target="_blank" rel="noopener noreferrer">Decreto nº 5.296 de 02 de dezembro de 2004</a>
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="body1" paragraph>
                        ...
                        <li>
                            <Typography variant="body1" paragraph>
                                <a href="http://www.planalto.gov.br/ccivil_03/_ato2011-2014/2012/decreto/d7724.htm" target="_blank" rel="noopener noreferrer">Decreto nº 7.724, de 16 de Maio de 2012</a> - Regulamenta a Lei No 12.527, que dispõe sobre o acesso a informações.
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="body1" paragraph>
                                <a href="http://www.governoeletronico.gov.br/acoes-e-projetos/e-MAG/documentos" target="_blank" rel="noopener noreferrer">Modelo de Acessibilidade de Governo Eletrônico</a>
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="body1" paragraph>
                                <a href="http://www.governoeletronico.gov.br/acoes-e-projetos/e-MAG/portaria-no-3-de-07-de-maio-de-2007" target="_blank" rel="noopener noreferrer">Portaria nº 03, de 07 de Maio de 2007</a> - Institucionaliza o Modelo de Acessibilidade em Governo Eletrônico – e-MAG
                            </Typography>
                        </li>
                    </ul>
                </div>
